...
public class SvnUtil {
     ...
     * @return
     */
    public static boolean isURLExist(SVNURL url,String username,String password) throws SVNException {
...
//        String userName = "linb";
//        String password = "s12345678";
//        SVNClientManager svnClientManager = SvnUtil.authSvn(url,userName,password);
